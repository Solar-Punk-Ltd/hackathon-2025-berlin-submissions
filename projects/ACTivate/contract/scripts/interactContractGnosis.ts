...
async function main() {
  console.log("=== DataContract Interaction Script (Gnosis Chain) ===\n");
  ...
  const topic = "Test Topic - Gnosis Chain Contract Interaction";
  ...
  console.log("View transactions on Gnosis Chain Explorer:");
